...
class GeometriesTest {
    ...
    void findIntsersections() {
        ...
        Geometries geometries = new Geometries(new Sphere(new Point3D(0,0.5, 0.5), 1) , //2 intersection points
        ...
        assertEquals(geometries.findIntsersections(ray).size(), 2, "Some of the geometries intersect doesn't work.");

        // =============== Boundary Values Tests ==================
        // TC02: Empty geometries set.
        geometries = new Geometries();
        assertNull(geometries.findIntsersections(ray), "Empty geometries set doesn't work.");

        // TC03: One geometry in the set intersects.
        geometries = new Geometries(new Sphere(new Point3D(0,0.5, 0.5), 1),
        ...
        // TC04: None of the geometries intersects.
        geometries = new Geometries(new Sphere(new Point3D(0,0.5, 4), 1),
        ...
        // TC05: All geometry in the set intersects.
        geometries = new Geometries(new Sphere(new Point3D(0,0.5, 0.5), 1), //2 intersection points
