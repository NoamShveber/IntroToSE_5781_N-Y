...
public class LightsTests {
	...
	void SphereMultiple() {
		...
		scene1.lights.add(new PointLight(new Color(500, 500, 0), new Point3D(0, 30, 10))
				.setKl(0.0000003).setKq(0.0000001));
		scene1.lights.add(new SpotLight(new Color(0, 900, 0), new Point3D(-100, -70, 50), new Vector(1, -1, -2))
