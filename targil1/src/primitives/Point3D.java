...
public class Point3D {
    ...
    public double distanceSquared(Point3D point) {
        return (point.x.coord - point.x.coord) * (point.x.coord - point.x.coord) +
                (point.y.coord - point.y.coord) * (point.y.coord - point.y.coord) +
                (point.z.coord - point.z.coord) * (point.z.coord - point.z.coord);
